...
class IPERTSProtocol(IPERProtocol):
    ...
    def __getitem__(self, item):
        ...
        start = self_imitation["range"][0]
        end = self_imitation["range"][1] + 1
        tgt_paths1 = src_img_paths[start:end - 2]
    ...
    def take_images_paths(self, vid_name, start, end):
        ...
        tgt_paths1 = vid_images_paths[start:end - 2]
        tgt_paths2 = vid_images_paths[start + 1:end - 1]
        tgt_paths3 = vid_images_paths[start + 2:end]
        images_paths = [(tgt_paths1[i], tgt_paths2[i], tgt_paths3[i]) for i in range(len(tgt_paths1))]
